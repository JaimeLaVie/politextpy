...
dictionary = {
    ...
    'dictionary_ko': {
        ...
        '키르기즈 공화국':'kg', '키르기스스탄':'kg','키르기즈':'kg',
        '타지키스탄 공화국':'tj', '타지키스탄':'tj',
        '우즈베키스탄 공화국':'uz', '우즈베키스탄':'uz',
        '아프가니스탄 이슬람 공화국':'af', '아프가니스탄':'af','아프가니스탄 이슬람 에미리트':'af',
        '이란':'ir','이란 이슬람 공화국':'ir',
        '몽골국':'mn', '몽골':'mn',
        '터키 공화국':'tr', '터키':'tr',
        '사우디아라비아 왕국':'sa', '사우디아라비아':'sa', '아라비아':'sa', '사우디':'sa',
        '이스라엘국':'il', '이스라엘':'il',
        '터키 공화국':'tr', '터키':'tr',
        '프랑스 공화국':'fr', '프랑스':'fr',
        '독일 연방공화국':'de', '독일':'de',
        '이탈리아 공화국':'it', '이탈리아':'it',
        '오스트리아 공화국':'at', '오스트리아':'at',
        '벨기에 왕국':'be', '벨기에':'be',
        '덴마크 왕국':'dk', '덴마크':'dk',
        '그리스 공화국':'gr', '그리스':'gr',
        '아이슬란드':'is', '아이슬란드 공화국':'is',
        '아일랜드':'ie', '아일랜드 공화국':'ie',
        '룩셈부르크 대공국':'lu', '룩셈부르크':'lu',
        '네덜란드':'nl',
        '노르웨이 왕국':'no', '노르웨이':'no',
        '포르투갈':'pt', '포르투갈 공화국':'pt',
        '스페인 왕국':'es', '스페인':'es',
        ...
        '헝가리':'hu', '헝가리 공화국':'hu',
        '폴란드 공화국':'pl', '폴란드':'pl',
        '슬로바키아 공화국':'sk', '슬로바키아':'sk',
        '슬로베니아':'si', '슬로베니아 공화국':'si',
        '에스토니아':'ee',
        '라트비아':'lv',
        '리투아니아 공화국':'lt', '리투아니아':'lt',
        '우크라이나':'ua',
        '러시아 연방':'ru', '러시아':'ru',
        '벨라루스 공화국':'by', '벨라루스':'by',
        '유럽 연합':'eu',
        ...
        '멕시코 합중국':'mx', '멕시코':'mx',
        '브라질 연방공화국':'br', '브라질':'br',
        '아르헨티나 공화국':'ar', '아르헨티나':'ar',
        '칠레 공화국':'cl', '칠레':'cl',
        '남아프리카 공화국':'za',
        '오스트레일리아 연방':'au', '오스트레일리아':'au',
        '뉴질랜드':'nz',    
    }
}
